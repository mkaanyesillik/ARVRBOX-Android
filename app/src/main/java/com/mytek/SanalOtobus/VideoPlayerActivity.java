 ...
 */
public class VideoPlayerActivity extends com.mytek.SanalOtobus.MD360PlayerActivity {

    private static final String TAG = "VideoPlayerActivity";
    private com.mytek.SanalOtobus.MediaPlayerWrapper mMediaPlayerWrapper = new com.mytek.SanalOtobus.MediaPlayerWrapper();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(com.mytek.SanalOtobus.R.id.control_next).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMediaPlayerWrapper.init();
                mMediaPlayerWrapper.openRemoteFile(com.mytek.SanalOtobus.DemoActivity.sPath + "video_31b451b7ca49710719b19d22e19d9e60.mp4");
                mMediaPlayerWrapper.prepare();
            }
        });
    ...
    protected MDVRLibrary createVRLibrary() {
        return MDVRLibrary.with(this)
                ...
                .projectionFactory(new com.mytek.SanalOtobus.CustomProjectionFactory())
