...
public abstract class MD360PlayerActivity extends Activity {
    ...
    static {
       // sDisplayMode.put(MDVRLibrary.DISPLAY_MODE_NORMAL,"NORMAL");
        ...
        sProjectionMode.put(com.mytek.SanalOtobus.CustomProjectionFactory.CUSTOM_PROJECTION_FISH_EYE_RADIUS_VERTICAL,"CUSTOM MULTI FISH EYE");
    ...
    public static void startBitmap(Context context, Uri uri){
        start(context, uri, com.mytek.SanalOtobus.BitmapPlayerActivity.class);
    }

    public static void startCubemap(Context context, Uri uri){
        start(context, uri, com.mytek.SanalOtobus.CubemapPlayerActivity.class);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // set content view
        setContentView(com.mytek.SanalOtobus.R.layout.activity_md_using_surface_view);
        ...
        hotspotPoints.add(findViewById(com.mytek.SanalOtobus.R.id.hotspot_point1));
        hotspotPoints.add(findViewById(com.mytek.SanalOtobus.R.id.hotspot_point2));

        com.mytek.SanalOtobus.SpinnerHelper.with(this)
                .setData(sDisplayMode)
                .setDefault(mVRLibrary.getDisplayMode())
                .setClickHandler(new com.mytek.SanalOtobus.SpinnerHelper.ClickHandler() {
                    @Override
                ...
                .init(com.mytek.SanalOtobus.R.id.spinner_display);
        ...
        com.mytek.SanalOtobus.SpinnerHelper.with(this)
                ...
                .init(com.mytek.SanalOtobus.R.id.spinner_interactive);
        ...
        com.mytek.SanalOtobus.SpinnerHelper.with(this)
                ...
                .init(com.mytek.SanalOtobus.R.id.spinner_projection);
        ...
        com.mytek.SanalOtobus.SpinnerHelper.with(this)
                ...
                .init(com.mytek.SanalOtobus.R.id.spinner_distortion);

        findViewById(com.mytek.SanalOtobus.R.id.button_add_plugin).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_add_plugin_logo).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MDHotspotBuilder builder = MDHotspotBuilder.create(mImageLoadProvider)
                        .size(4f,4f)
                        .provider(activity, com.mytek.SanalOtobus.R.drawable.moredoo_logo)
                        .title("logo")
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_remove_plugin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (plugins.size() > 0){
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_remove_plugins).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                plugins.clear();
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_add_hotspot_front).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MDHotspotBuilder builder = MDHotspotBuilder.create(mImageLoadProvider)
                        .size(4f,4f)
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_rotate_to_camera_plugin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_add_md_view).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_update_md_view).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_md_view_hover).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = new com.mytek.SanalOtobus.HoverView(activity);
        ...
        final TextView hotspotText = (TextView) findViewById(com.mytek.SanalOtobus.R.id.hotspot_text);
        final TextView directorBriefText = (TextView) findViewById(com.mytek.SanalOtobus.R.id.director_brief_text);
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_camera_little_planet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(com.mytek.SanalOtobus.R.id.button_camera_to_normal).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MDDirectorCamUpdate cameraUpdate = getVRLibrary().updateCamera();
        ...
        com.mytek.SanalOtobus.SpinnerHelper.with(this)
                ...
                .init(com.mytek.SanalOtobus.R.id.spinner_pitch_filter);
        ...
        com.mytek.SanalOtobus.SpinnerHelper.with(this)
                ...
                .init(com.mytek.SanalOtobus.R.id.spinner_fling_enable);
    }
    ...
    public void cancelBusy(){
        findViewById(com.mytek.SanalOtobus.R.id.progress).setVisibility(View.GONE);
    }

    public void busy(){
        findViewById(com.mytek.SanalOtobus.R.id.progress).setVisibility(View.VISIBLE);
    }
