...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sMockData = new Uri[] {
                getDrawableUri(com.mytek.SanalOtobus.R.drawable.bitmap360)
                ,getDrawableUri(com.mytek.SanalOtobus.R.drawable.texture)
        };

        setContentView(com.mytek.SanalOtobus.R.layout.activity_main);
        manager = new VRLibManager(this);

        RecyclerView recyclerView = (RecyclerView) findViewById(com.mytek.SanalOtobus.R.id.recycler_view);
    ...
    private class FeedTextVH extends FeedVH {
        ...
        public FeedTextVH(ViewGroup vp) {
            super(vp, com.mytek.SanalOtobus.R.layout.feed_text_layout);
        }
    ...
    private class FeedVRVH extends FeedVH implements MDVRLibrary.IBitmapProvider {
        ...
        public FeedVRVH(ViewGroup vp) {
            super(vp, com.mytek.SanalOtobus.R.layout.feed_panorama_layout);
            text = (TextView) itemView.findViewById(com.mytek.SanalOtobus.R.id.feed_text);
            glTextureView = (GLTextureView) itemView.findViewById(com.mytek.SanalOtobus.R.id.feed_texture_view);
