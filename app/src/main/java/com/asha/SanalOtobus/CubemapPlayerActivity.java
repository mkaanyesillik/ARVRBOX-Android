...
public class CubemapPlayerActivity extends MD360PlayerActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(com.mytek.SanalOtobus.R.id.control_next).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected MDVRLibrary createVRLibrary() {
        return MDVRLibrary.with(this)
                    ...
                    public void onProvideCubemap(MD360CubemapTexture.Callback callback, int cubeFace) {
                        ...
                        switch(cubeFace) {
                            case MD360CubemapTexture.CUBE_FRONT:
                                nextUri = getDrawableUri(com.mytek.SanalOtobus.R.drawable.cube_front);
                                break;
                            case MD360CubemapTexture.CUBE_BACK:
                                nextUri = getDrawableUri(com.mytek.SanalOtobus.R.drawable.cube_back);
                                break;
                            case MD360CubemapTexture.CUBE_TOP:
                                nextUri = getDrawableUri(com.mytek.SanalOtobus.R.drawable.cube_top);
                                break;
                            case MD360CubemapTexture.CUBE_BOTTOM:
                                nextUri = getDrawableUri(com.mytek.SanalOtobus.R.drawable.cube_bottom);
                                break;
                            case MD360CubemapTexture.CUBE_LEFT:
                                nextUri = getDrawableUri(com.mytek.SanalOtobus.R.drawable.cube_left);
                                break;
                            case MD360CubemapTexture.CUBE_RIGHT:
                                nextUri = getDrawableUri(com.mytek.SanalOtobus.R.drawable.cube_right);
                                break;
                            default:
                                    return;
                        }
                ...
                .pinchEnabled(true)
                .build(findViewById(com.mytek.SanalOtobus.R.id.gl_view));
    }
